...
### بناء استعارة نابعة من المصدر داخل دراسة إيزومترية مضيئة
...
> استعارة موضوعية · نظام إيزومتري · مخطوط باهت · لون ياباني صافٍ · فراغ شرقي

يحفظ نموذج إيزومتري متماسك هوية المصدر، وتصبح استعارة هندسية واحدة قاعدة أو فجوة أو مساراً أو إحاطة أو شكلاً سلبياً. وتبقى الدراسات الباهتة آثاراً ثانوية للتفكير حول الشكل المضيء المكتمل.
...
- **الارتباط بالمصدر:** بناء استعارة نابعة من المصدر داخل دراسة إيزومترية مضيئة
- **بصمة الأسلوب:** استعارة موضوعية · نظام إيزومتري · مخطوط باهت · لون ياباني صافٍ · فراغ شرقي
...
توجد القيود الجمالية وقواعد الرفض الكاملة في المهارة وتوجيهات الإنتاج. وهي تحفظ دافع النص الأصلي من دون تحويل لوحة 3:4 التاريخية إلى قيمة افتراضية خفية. [SKILL.md](SKILL.md) · [production prompt](references/xxd-panel-041-prompt.en.md)

## النماذج · من X

> [Xiaoxiaodong (@xiaoxiaodong01)](https://x.com/xiaoxiaodong01/status/2091001986519068891) · 22 أغسطس 2026<br>
> GPT2 × منظور متساوي القياس × ليوناردو دا فينشي × توجيه جمالي<br>ملاحظة: «VOL.401» في المنشور الأصلي خطأ في الترقيم؛ وقد أكد المؤلف أن هذه النماذج تخص XXD Panel 041.

<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091001986519068891"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 041 نموذج 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091001986519068891"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 041 نموذج 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091001986519068891"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 041 نموذج 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091001986519068891"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 041 نموذج 4"></a></td>
  </tr>
</table>

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2091001986519068891">عرض المنشور الأصلي والتوجيه كاملاً ←</a></p>

تعرض هذه النماذج الدافع الجمالي للإصدار 041 فقط؛ ولا تصبح موضوعاتها أو تكوينها أو ألوانها أو نصوصها أو نسبة اللوحة السابقة مراجع للتوليد أو إعدادات افتراضية حالية.
...
| --- | --- | --- |
| `top-bottom` | لوحة نهائية أكدها المستخدم | توليد كامل واحد: المصدر عالي الوفاء في الأعلى وتصميم 041 في الأسفل، نحو 50/50 |
| `left-right` | لوحة نهائية أكدها المستخدم | توليد كامل واحد: المصدر عالي الوفاء يساراً وتصميم 041 يميناً، نحو 50/50 |
| `design-only` | لوحة نهائية أكدها المستخدم | يملأ تصميم 041 اللوحة ولا تظهر صورة المصدر |
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-041`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/041-source.md) · [توجيه الإنتاج الإنجليزي](references/xxd-panel-041-prompt.en.md) · [توجيه الإنتاج الصيني](references/xxd-panel-041-prompt.zh-CN.md)
...
<div align="center" dir="rtl"><strong>يتقاسم الشكل المكتمل وأثر التفكير حقلاً هادئاً واحداً.</strong></div>
